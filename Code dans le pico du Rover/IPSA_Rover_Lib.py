...
class IpsaRoverLib
    ...
    def set_motor_parameters(self)
        ...
        time.sleep(0.05)
        self.write_register(REG['PULSE_PER_LINE'], [0x00, 13])            # 13 pulseline
        time.sleep(0.05)
    ...
    def percent_pwm(self, pc)
        return self.PWM_MIN + (self.PWM_MAX-self.PWM_MIN)(.01pc)
    # -------------------------
    # Motor Control
    # -------------------------
...
if __name__ == __main__
    ...
    print(f1  {driver.read_encoder_deltas()})
    print(fRPM  {driver.calculate_rpm(ticks[0])})
    time.sleep(2)
    driver.control_motor_speed(0, 0, 0, 0)
    ...
    for mes in range(10)
        ...
        print(fTemps de vol de l'onde  {echo_time_ms})
        time.sleep(.5)
